...
import {CheckNenWork} from '../util/request.tsx';
...
function HomePage() {
  ...
  return (
    <>
                ...
                <Card.Title
                  ...
                  right={props => (
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                      <IconButton
                        {...props}
                        icon={v.serverOnline ? 'circle' : 'alert-circle'}
                        iconColor={v.serverOnline ? 'green' : MD3Colors.error50}
                      />
                      <IconButton
                        {...props}
                        icon="archive-edit"
      ...
      <FAB icon="plus" style={Styles.fab} onPress={fabhandle} />
    </>
  );
}
